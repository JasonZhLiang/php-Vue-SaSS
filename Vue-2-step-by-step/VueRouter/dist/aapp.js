...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_Form_js__ = __webpack_require__(160);
        ...
        value: function submit(requestType, url) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                axios[requestType](url, {
                    params: _this.data()
                }) //without params, $_GET cannot be retrieved ref: https://stackoverflow.com/questions/40947650/axios-get-in-url-works-but-with-second-parameter-as-object-it-doesnt
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AddToStream_vue__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AddToStream_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__AddToStream_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        AddToStream: __WEBPACK_IMPORTED_MODULE_1__AddToStream_vue___default.a
    },
    data: function data() {
        return {
            statuses: []
    ...
    methods: {
        ...
        addStatus: function addStatus(sta) {
            console.dir(sta);
...
Component.options.__file = "views/AddToStream.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7e760e3d", Component.options)
  } else {
    hotAPI.reload("data-v-7e760e3d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            this.form.get('./sta.php').then(function (re) {
                return _this.$emit('completed', re);
            });
            //for some unknown reason, post does not work, but get does. even use jquery $.post as below still cause problem, but $.get works fine.
            //                $.get("./sta.php",
            //                    {
            //                        body: "Joe Doe",
            //                        city: "Ottawa"
          ...
          _c("p", { staticClass: "control" }, [
            ...
            _vm.form.errors.any()
              ? _c("span", {
                  ...
                  domProps: { textContent: _vm._s(_vm.form.errors.getErros()) }
                })
              : _vm._e()
          ]),
          _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7e760e3d", module.exports)
  }
}
